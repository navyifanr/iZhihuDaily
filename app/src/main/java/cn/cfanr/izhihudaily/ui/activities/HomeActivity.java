...
public class HomeActivity extends BaseActivity implements HomeView{
    ...
    protected void initEvent() {
        ...
        homePresenter.loadHomeData(-1, 0, lastNewsId);
    ...
    @Override
    public void showHomeData(List<NewsModel> bannerList, String title, List<NewsModel> newsModelList) {
    ...
    @Override
    public void showThemeDailyData(String description, String background, List<EditorModel> editorModelList, List<NewsModel> themeNewsList) {
    ...
    @Override
    public void setDrawerMenu(final List<ThemeModel> themeModelList) {
        mListView.setAdapter(new CommonAdapter<ThemeModel>(getActivity(), themeModelList, R.layout.item_drawer_theme) {
            @Override
