...
import cn.cfanr.izhihudaily.ui.activities.EditorsActivity;
...
public class ThemeDailyHeader extends RecyclerView.ViewHolder{
    ...
    public void refreshUI(ThemeDailyModel themeDailyModel){
        ...
        final List<Editor> editorModelList=themeDailyModel.getEditorModelList();
        mRecyclerView.setAdapter(mAdapter=new BaseRecyclerAdapter<Editor>(mRecyclerView, editorModelList, R.layout.item_theme_editor_avatar) {
            @Override
            public void convert(RecyclerHolder holder, Editor editorModel, int position, boolean isScrolling) {
